...
<body>
    ...
    <p>
        LAT: <input type="text" id="latInput" value="<%= (request.getParameter("latInput") != null) ? request.getParameter("latInput") : "0.0" %>"> , LNT: <input type="text" id="lntInput" value="<%= (request.getParameter("lntInput") != null) ? request.getParameter("lntInput") : "0.0" %>">
